//! Axum integration for hooksmith.
//!
...
/// ```rust,no_run
/// # use axum::Router;
/// # use hooksmith_axum::WebhookSecretLayer;
/// let app: Router = Router::new()
///     /* ... routes ... */
...
/// Axum extractor that verifies the hooksmith HMAC-SHA256 signature and
...
/// Axum extractor that verifies the hooksmith signature and deserializes the
/// JSON body into `T`.
///
